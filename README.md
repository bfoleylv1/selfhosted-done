...
A library of **518** Docker Compose + Docker Swarm stacks for self-hosted services. Each folder contains a working `docker-compose.yml` (single host) and `swarm/docker-stack.yml` (cluster), with healthchecks, Homepage labels, and config/data volume mounts.

Every stack was generated from the project's real upstream image and tagged with its actual category and host port. Descriptions come from each project's official catalog/repo where available.

> **Description sourcing:** most descriptions are sourced from the bundled `selfhosted-list.txt` catalog or the project's own README. A few that could not be confirmed from a local source are marked **⚠** (best-effort, not web-verified) — double-check those before relying on them. No description is fabricated; the ⚠ ones will be replaced with verified text + official links once a web pass is run.

## At a glance

- **Services:** 518
- **With GPU / hardware-acceleration blocks:** 46 (commented out — uncomment to enable)
- **Categories:** 34
- **Descriptions marked ⚠ (not web-verified):** 188
...
| [Crucial](./crucial) | `alpine:3.20` | `20038` | — | ⚠ Self-hosted service (description needs web verification). |
| [Daisy](./daisy) | `alpine:3.20` | `20040` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Docuddle](./docuddle) | `alpine:3.20` | `20046` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Ekso](./ekso) | `alpine:3.20` | `20057` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Fmd Server](./fmd-server) | `golang:1.23-alpine` | `20071` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Full Help](./full-help) | `alpine:3.20` | `20083` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Gomodel](./gomodel) | `golang:1.23-alpine` | `20099` | — | ⚠ Self-hosted service (description needs web verification). |
| [Google Cse Proxy](./google-cse-proxy) | `node:20-alpine` | `20100` | — | ⚠ Proxy for the Google Custom Search Engine API. |
| [Gordian](./gordian) | `alpine:3.20` | `20101` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Libervrt](./libervrt) | `lscr.io/linuxserver/emby:latest` | `20139` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Lms](./lms) | `lmscommunity/lyrionmusicserver:latest` | `20142` | — | ⚠ Self-hosted service (description needs web verification - likely a library management system). |
...
| [Openclaw](./openclaw) | `ghcr.io/openclaw/openclaw:latest` | `20175` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Phice](./phice) | `alpine:3.20` | `20201` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Repo Flow](./repo-flow) | `alpine:3.20` | `20240` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Revent](./revent) | `alpine:3.20` | `20246` | — | ⚠ Self-hosted service (description needs web verification). |
| [Revert](./revert) | `node:20-alpine` | `20247` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Sama](./sama) | `alpine:3.20` | `20264` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Seppo](./seppo) | `alpine:3.20` | `20273` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Smederee](./smederee) | `alpine:3.20` | `20284` | — | ⚠ Self-hosted service (description needs web verification). |
| [Smite](./smite) | `alpine:3.20` | `20285` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Supers3Cret](./supers3cret) | `alpine:3.20` | `20311` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Surge](./surge) | `node:20-alpine` | `20314` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Teikei](./teikei) | `node:20-alpine` | `20320` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Txtdot](./txtdot) | `node:20-alpine` | `20339` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Wagmios](./wagmios) | `alpine:3.20` | `20352` | — | ⚠ Self-hosted service (description needs web verification). |
| [Wakapi](./wakapi) | `ghcr.io/muety/wakapi:latest` | `20353` | — | ⚠ Self-hosted coding time and activity tracker (WakaTime compatible). |
| [Watchcode](./watchcode) | `alpine:3.20` | `20355` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Xcpg](./xcpg) | `ubuntu:24.04` | `20373` | ✅ | ⚠ Self-hosted service (description needs web verification). |
...
| [Zeit](./zeit) | `node:20-alpine` | `20383` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Zk Cloudserver](./zk-cloudserver) | `alpine:3.20` | `20388` | — | ⚠ Self-hosted service (description needs web verification). |
...
| [Pixelfed](./pixelfed) | `zknt/pixelfed:latest` | `20206` | — | Free and open source photo sharing platform; Instagram alternative. |
...
| [Minio](./minio) | `quay.io/minio/minio:latest` | `20157` | — | High-performance, distributed object storage; S3-compatible API. |
